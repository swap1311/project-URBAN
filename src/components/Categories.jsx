const Categories = () => {
  return (
    <>
      <div className="text-[24px] md:text-[36px] bg-[white] w-full font-[poppins] font-[500] text-center mb-4 md:mb-6">
        Top Categories
      </div>

      <div className="w-full h-auto bg-[white] flex flex-col md:flex-row justify-center gap-[10px]">
        <div className="w-full md:w-[50%] bg-[white] mb-4 md:mb-0">
          <img
        ...
        <div className="w-full md:w-[50%] bg-[white] flex flex-col gap-[19px]">
